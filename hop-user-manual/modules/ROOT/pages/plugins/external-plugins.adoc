...
The https://github.com/project-hop/hop-plugins/[Hop plugins, role="ext-link"] repository contains a collection of plugins that can be used with but can't or won't be shipped with Apache Hop.
